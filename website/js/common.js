...
const SERVICES_GROUP_JSON = '{"计算":["AWS Batch","AWS Elastic Beanstalk","AWS Elastic Beanstalk Health Service","AWS Lambda","Amazon EC2 Container Registry (ECR)","Amazon EC2 Container Service (ECS)","Amazon Elastic Compute Cloud (EC2)","Amazon Lightsail","Auto Scaling","AWS Serverless Application Repository"],"存储":["AWS Storage Gateway","Amazon Elastic File System (EFS)","Amazon Glacier","Amazon Simple Storage Service (S3)"],"数据库":["Amazon DynamoDB","Amazon DynamoDB Streams","DynamoDB Accelerator (DAX)","Amazon ElastiCache","Amazon Redshift","Amazon Relational Database Service (RDS)","Amazon SimpleDB"],"网站和内容分发":["AWS Direct Connect","Amazon Virtual Private Cloud (VPC)","Elastic Load Balancing","Amazon Route 53 Domain Registration","Amazon Route 53 Auto Naming"],"迁移":["AWS Application Discovery Service","AWS Database Migration Service","Amazon Server Migration Service","AWS Snowball"],"开发人员工具":["AWS CodeBuild","AWS CodeCommit","AWS CodeDeploy","AWS CodePipeline","AWS CodeStar","AWS X-Ray","AWS Cloud9"],"管理工具":["AWS CloudFormation","AWS CloudTrail","AWS Config","AWS Config Rules","AWS OpsWorks Stacks","AWS OpsWorks for Chef Automate","AWS Service Catalog","Amazon CloudWatch","Amazon CloudWatch Events","Amazon CloudWatch Logs","Amazon EC2 Systems Manager","AWS Resource Groups"],"媒体服务":["Amazon MediaConvert","Amazon MediaLive","Amazon MediaPackage","Amazon MediaStore","Amazon MediaTailor"],"安全、身份与合规":["Amazon Cloud Directory","AWS Certificate Manager","AWS CloudHSM","AWS CloudHSM Classic","AWS Directory Service","AWS Key Management Service","AWS Organizations","AWS STS","AWS WAF","Amazon Inspector","Amazon GuardDuty"],"分析":["AWS Data Pipeline","Amazon Athena","Amazon CloudSearch","Amazon Elastic MapReduce (EMR)","Amazon Elasticsearch Service","Amazon Kinesis Analytics","Amazon Kinesis Firehose","Amazon Kinesis Data Streams","Amazon Kinesis Video Streams","Amazon QuickSight","Amazon Glue"],"人工智能":["Amazon Lex","Amazon Machine Learning","Amazon Polly","Amazon Rekognition","Amazon Comprehend","Amazon SageMaker","Amazon Transcribe","Amazon Translate"],"物联网":["AWS IoT","Amazon Greengrass"],"游戏开发":["Amazon GameLift"],"移动服务":["AWS Device Farm","Amazon Cognito Federated Identities","Amazon Cognito Sync","Amazon Cognito Your User Pools","Amazon Mobile Analytics","Amazon Pinpoint","AWS AppSync"],"应用程序服务":["AWS Step Functions","Amazon API Gateway","Amazon Elastic Transcoder","Amazon Simple Workflow Service (SWF)"],"消息":["Amazon Simple Email Service (SES)","Amazon Simple Notification Service (SNS)","Amazon Simple Queue Service (SQS)","Amazon Simple Queue Service (SQS) Legacy","Amazon Connect","Amazon MQ"],"企业生产力":["Amazon WorkMail","Amazon WorkDocs","Alexa for Business"],"桌面和应用串流":["Amazon AppStream","Amazon AppStream 2.0","Amazon WorkSpaces"],"其他":["AWS Billing Price List Service","Amazon Mechanical Turk"]}'
const EXCEPTIONS_JSON = '{"exceptions":[]}'
const REGIONS_INFO_JSON = '{"ap-northeast-1":"Tokyo","ap-northeast-2":"Seoul","ap-south-1":"Mumbai","ap-southeast-1":"Singapore","ap-southeast-2":"Sydney","ca-central-1":"Montreal","cn-north-1":"Beijing","eu-central-1":"Frankfurt","eu-west-1":"Ireland","eu-west-2":"London","sa-east-1":"S&atilde;o Paulo","us-east-1":"Northern Virginia","us-east-2":"Ohio","us-gov-west-1":"GovCloud","us-west-1":"Northern California","us-west-2":"Oregon","ap-northeast-3":"Osaka","cn-northwest-1":"Ningxia","eu-west-3":"Paris"}'
const DEFAULT_CHECKED_REGION = ["us-east-1", "us-east-2", "us-west-1", "us-west-2", "cn-north-1", "cn-northwest-1"]
...
function store_services_status(services_data) {
	...
	var exceptions_json = eval("("+EXCEPTIONS_JSON+")");
	console.log("The following will be an array which store exceptions");
	console.log(exceptions_json);
	console.log(services_status);
	
	for (var i = 0; i < exceptions_json.exceptions.length; i++)
		services_status[exceptions_json.exceptions[i].service][exceptions_json.exceptions[i].region] = "0";
}
...
function reload_services_status() {
	...
	console.log("The following will be an array which store services in groups");
...
function create_download_csv_file_button() {
	...
	var download_node = document.createTextNode("下载 .csv 文件");
